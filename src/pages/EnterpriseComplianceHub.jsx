...
export default function EnterpriseComplianceHub() {
  ...
  return (
    ...
    >
      ...
      {/* Safety Summary */}
      <HubCard icon={HeartPulse} title="Safety Summary" subtitle="Open incidents and critical alerts across all streams" tone="rose">
      ...
      <HubCard icon={ShieldCheck} title="Compliance by Stream" subtitle="Expired certs, expiring items and open incidents per stream" tone="violet">
        {isLoading ? (
