...
const HUBS = [
  {
    ...
    items: [
      ...
      { done: true, text: 'Mobile layout — dashboard grid now single-column on phones — this round' },
  ...
  },
  {
    ...
    items: [
      ...
      { done: true, text: "Live map filter — off-shift crew now visible with muted ring — this round" },
  ...
  },
  {
    ...
    items: [
      ...
      { done: true, text: 'Settings nav — search box + group labels already in sidebar' },
