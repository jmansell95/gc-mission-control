...
export default function AssetScannerPage() {
    ...
    return (
      <>
        <div className="fixed inset-0 page-bg-vibrant flex flex-col">
          <header className="hub-glass border-b border-slate-200/80 px-4 py-3 flex items-center justify-between flex-shrink-0 safe-area-top">
  ...
  return (
    <div className="fixed inset-0 page-bg-vibrant flex flex-col">
      ...
      <div className="hub-glass border-b border-slate-200/80 px-3 py-2 flex-shrink-0">
          ...
          {hubTab === 'scan' && (
            <>
              ...
              <div className="flex items-center gap-2 text-xs">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg hub-glass font-semibold text-slate-600">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-hub-gap">
                ...
                <div className="hidden md:block">
                  <div className="hub-glass rounded-2xl p-4 sticky top-4">
