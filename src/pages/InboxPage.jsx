      ...
      <div className="max-w-4xl mx-auto px-4 py-6 md:py-8">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 hub-glass rounded-xl text-sm text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/30"
          />
        </div>
