  ...
  return (
    <div className="min-h-screen page-bg-vibrant">
      ...
      <div className="relative">
        ...
        <div className="relative px-3 sm:px-4 md:px-6 lg:px-8 pt-4 lg:pt-6 pb-5 lg:pb-6 safe-area-top">
      ...
      {/* ─── Division Breakdown ─── */}
      <div className="px-3 sm:px-4 md:px-6 lg:px-8 pb-24 xl:pb-8 max-w-[1600px] mx-auto">
