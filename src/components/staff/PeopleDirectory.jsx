                ...
                <div key={u.id} className="bg-white/70 rounded-xl p-3 flex items-center gap-3 border border-amber-100">
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <button
                      ...
                      disabled={actioningId === u.id}
                      className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-primary text-white rounded-lg text-xs font-semibold hover:brightness-110 transition disabled:opacity-50"
                    >
                        ...
                        {subTeams.map((st) => {
                          ...
                          return (
                            <button
                              ...
                              className="w-full flex items-center gap-2 px-3 py-2 bg-white rounded-lg border border-slate-100 hover:border-primary/30 hover:bg-primary/[0.02] transition text-left"
                            >
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-1.5">
          <p className="text-sm font-medium text-slate-800 truncate group-hover:text-primary transition">{member.name}</p>
      ...
      {canInvite && (
        <button
          ...
          disabled={isInviting}
          className="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-primary text-white hover:bg-primary/90 text-[10px] font-semibold transition flex-shrink-0 disabled:opacity-50"
      ...
      {onOpenPermissions && (
        <button
          ...
          className="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-slate-100 hover:bg-primary hover:text-white text-slate-600 text-[10px] font-semibold transition flex-shrink-0"
