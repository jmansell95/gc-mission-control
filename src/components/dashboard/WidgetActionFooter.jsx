  ...
  return (
    <div className="flex gap-2 mt-2">
      <button
        ...
        className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-xs font-bold hover:bg-slate-50 active:scale-[0.98] transition"
      >
      ...
      <button
        ...
        className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-[#2E5A1A] text-white rounded-lg text-xs font-bold hover:bg-[#244715] active:scale-[0.98] transition"
      >
