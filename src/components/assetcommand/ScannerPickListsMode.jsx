 ...
 * Asset Scanner so warehouse staff can see everything that needs picking and
 * complete the full 3-stage drawn-signature sign-off without leaving the scanner.
 *
...
export default function ScannerPickListsMode({ onBack }) {
  ...
  return (
    <div className="fixed inset-0 bg-[#F5FBF6] flex flex-col">
      ...
      {/* Pick list modal — full 3-stage drawn-signature sign-off */}
      {openDelivery && (
        <PickListModal
