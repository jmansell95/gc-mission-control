...
import { ChevronLeft, ChevronRight, Hotel, Home } from 'lucide-react';
import { bookingType } from '@/components/jobs/hotelCost';
  ...
  return (
    <div className="hub-glass rounded-2xl overflow-hidden">
      ...
      <div className="grid grid-cols-[140px_repeat(7,1fr)] gap-0 border-b border-slate-100 bg-slate-50/50">
        <div className="px-3 py-2 text-[10px] font-semibold text-slate-400 uppercase tracking-wide">Property</div>
        {days.map(d => {
