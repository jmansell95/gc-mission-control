...
import {
  Mountain, TrendingUp, Clock, AlertTriangle, PoundSterling, Activity,
} from 'lucide-react';
...
// Drilling-specific activity summary: borehole completion, daily metreage
// chart, cost per metre, and delay breakdown. Shown on the Site Activity
// tab for CP and Rotary drilling jobs.
export default function DrillingActivitySummary({ job, invLogs, canSeeCosts, fin }) {
