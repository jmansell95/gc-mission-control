        ...
        <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
          ...
          {secondaryAction && (
            <button
              ...
              className="inline-flex items-center gap-1.5 h-9 px-3 bg-white border border-slate-200 text-slate-700 rounded-xl text-ui-caption font-semibold hover:bg-slate-50 active:scale-[0.98] transition"
            >
