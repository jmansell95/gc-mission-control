  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 h-9 px-2.5 sm:px-3 rounded-xl border border-slate-200 bg-white/80 text-slate-500 hover:text-[#2E5A1A] hover:border-[#2E5A1A]/30 hover:bg-[#2E5A1A]/5 text-xs font-semibold transition active:scale-[0.97]"
      >
