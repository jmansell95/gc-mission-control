      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-pop-in" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-xl bg-emerald-100 text-[#2E5A1A] flex items-center justify-center">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input value={name} onChange={e => setName(e.target.value)} autoFocus
              ...
              className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:border-[#2E5A1A] focus:ring-2 focus:ring-emerald-100 outline-none" />
          </div>
          ...
          <button onClick={() => setIsShared(!isShared)}
            ...
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${isShared ? 'bg-emerald-100 text-[#2E5A1A]' : 'bg-slate-100 text-slate-400'}`}>
            ...
            <div className={`w-10 h-6 rounded-full transition ${isShared ? 'bg-[#2E5A1A]' : 'bg-slate-200'} relative`}>
