      ...
      {pills.map(p => {
        ...
        return (
          <button
            ...
            type="button"
            className={`group relative inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-hub-body font-semibold transition-all flex-shrink-0 sm:flex-1 justify-center sm:justify-start whitespace-nowrap active:scale-[0.97] ${
              isActive
