        ...
        <div className="px-5 pt-4">
          <div className="grid grid-cols-2 gap-2 p-1 bg-slate-100 rounded-xl">
            <button type="button" onClick={() => setMode('create')}
              className={`flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-sm font-semibold transition ${mode === 'create' ? 'bg-white text-primary shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    {selectedJob?.start_date && (
                      <div className="mt-1.5 flex items-center gap-1.5 text-[11px] text-primary bg-primary/5 border border-primary/15 rounded-lg px-2.5 py-1.5">
