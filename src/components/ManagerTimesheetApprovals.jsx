...
import { Clock, CheckCircle2, XCircle, TrendingUp, ClipboardCheck, ShieldCheck, Car, AlertTriangle, Zap, Bot } from 'lucide-react';
import { format } from 'date-fns';
import { computeStaffOvertime, buildRateMap, entryMinutes } from '@/utils/overtime';
import TimesheetConfidenceQueue from '@/components/timesheets/TimesheetConfidenceQueue';
...
export default function ManagerTimesheetApprovals({ staffId }) {
  ...
  return (
    <div className="space-y-3">
      {/* View toggle — Auto (confidence queue) vs Manual (legacy list) */}
