...
import { FlaskConical, Plus, Send, CheckCircle2, Clock, AlertTriangle, Trash2, Edit2, Truck, Package, ClipboardCheck } from 'lucide-react';
          ...
          <div className="space-y-2">
            {sorted.length === 0 ? (
              ...
              sorted.map(s => {
                ...
                return (
                  <div key={s.id} className="bg-[#1C201C] border border-[#2a3a2a] rounded-xl p-3 hover:border-[#3a4a3a] transition">
