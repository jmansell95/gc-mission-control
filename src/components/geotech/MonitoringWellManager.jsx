  ...
  return (
    <div className="insight-card rounded-2xl overflow-hidden">
      ...
      {overdueWells.length > 0 && (
        <div className="px-5 py-2.5 border-b border-slate-100 flex items-center gap-2 bg-rose-50">
      ...
      {isLoading ? (
        ...
        <div className="px-5 py-8 text-center">
          ...
          <p className="text-sm text-slate-600">No monitoring wells installed.</p>
        ...
        <div className="divide-y divide-slate-100">
          {wells.map(w => {
            ...
            return (
              <div key={w.id} className="px-5 py-3 hover:bg-slate-50 transition">
