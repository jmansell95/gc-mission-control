  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-10">
      <div className="hub-glass rounded-2xl p-8 text-center">
        ...
        <button
          onClick={onBack}
          className="mt-6 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-white bg-[#2E5A1A] hover:bg-[#1c4a12] transition active:scale-95"
        >
