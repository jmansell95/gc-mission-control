...
const SelectContent = React.forwardRef(({ className, children, position = "popper", ...props }, ref) => {
  ...
  React.useEffect(() => {
    ...
    // Toggle a "no results" sentinel
    const sentinel = viewport.querySelector('[data-search-empty]')
    if (sentinel) sentinel.style.display = anyVisible ? "none" : ""
  }, [search])
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        <SelectPrimitive.Viewport
          ...
          {children}
          <div data-search-empty style={{ display: "none" }} className="py-4 text-center text-xs text-muted-foreground">
            No matches
          </div>
        </SelectPrimitive.Viewport>
