...
import EmailTemplateBuilder from '@/components/settings/EmailTemplateBuilder';
import ReportTemplateBuilder from '@/components/settings/ReportTemplateBuilder';
import KeyLogBookSettings from '@/components/settings/KeyLogBookSettings';
...
import RequestRoutingManager from '@/components/settings/RequestRoutingManager';
...
export default function SettingsPage({ initialTab, onSelectJob, standalone }) {
  ...
  const renderSettingsComponent = () => {
    switch (activeTab) {
      ...
      case 'request-routing': return <RequestRoutingManager />;
      ...
      case 'email-templates': return <EmailTemplateBuilder />;
      case 'report-templates': return <ReportTemplateBuilder />;
      ...
      case 'ags-import': return <KeyLogBookSettings />;
